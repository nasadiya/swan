...
def calculate_swap(instruments, ten='3y', fixed_rate=0.0, fwd_strt="2D", nominal=1e6):
    ...
    swap = ql.MakeVanillaSwap(t, index, fixedRate, forwardStart, Nominal=nominal, pricingEngine=engine)
